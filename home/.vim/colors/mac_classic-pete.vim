...
hi CursorLine  guibg=#F0F6FF ctermbg=195
hi CursorColumn  guibg=#F0F6FF ctermbg=195
hi LineNr  guifg=#808080 ctermfg=244 guibg=#EFEFEF ctermbg=255
hi VertSplit  guifg=#CFCFCF ctermfg=7 guibg=#CFCFCF ctermbg=7 gui=NONE
...
" StatusLine: {{{2
hi StatusLine  guifg=#000000 ctermfg=153 guibg=#C6DEFF ctermbg=0 gui=NONE
